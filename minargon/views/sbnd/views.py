...
DEAD_CH = sorted([4800, 4801, 4802, 4803, 4804, 4805,
                  ...
                  4190, 4191])
DEAD_CHANNEL_LIST = ["3232-3263", "4160-4191", "4800-4805", "10438-10443"]
SHORT_CH = sorted([7169, 8378, 5060])
NOISY_SHORT_CH = sorted([3048, 4405])
...
"Bottom Wall": sorted([82, 86, 90, 91, 99, 100, 93, 94, 95, 97, 98, 77, 78, 83, 104, 103, 102, 101, 28, 43, 4, 29]),
...
def introduction():
    ...
    render_args = {
      ...
      "dead_chs": DEAD_CH,
      "short_chs": SHORT_CH,
      "noisy_short_chs": NOISY_SHORT_CH,
...
def TPC_status():
    ...
    render_args = {
      ...
      "tpc_planes": TPC_PLANES,
      "dead_chs": DEAD_CH,
      "dead_ch_list": DEAD_CHANNEL_LIST,
      "short_chs": SHORT_CH,
      "noisy_short_chs": NOISY_SHORT_CH,
      "tpc_rms_max": TPC_RMS_ALARM_MAX,
